...
public sealed class OscScope(CasparClient client)
{
    ...
    public ValueTask StartAsync(int port, CancellationToken cancellationToken) =>
    ...
    public ValueTask SubscribeAsync(int port, CancellationToken cancellationToken) =>
    ...
    public ValueTask UnsubscribeAsync(int port, CancellationToken cancellationToken) =>
