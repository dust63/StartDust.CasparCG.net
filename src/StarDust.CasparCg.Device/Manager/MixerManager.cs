...
using  StarDust.CasparCG.Models.Mixer;
...
namespace  StarDust.CasparCG.Device
{
    public class MixerManager
    {
        ...
        public void Keyer(int layer, bool enable, bool deffered = false)
        {
        ...
        public void Chroma(int layer, bool enable, bool deffered = false)
        {
            string str1 = GetDefferMode(deffered);
            string str2 = enable ? "1" : "0";
        ...
        public void Chroma(int layer, bool enable, float targetHue, float hueWidth, float minSaturation, float minBrightness, float softness, float spillSupress, float spillSuppresSaturation, bool showMask, bool deffered = false)
        {
            string str1 = GetDefferMode(deffered);
            string str2 = enable ? "1" : "0";
        ...
        public void BlendMode(int layer, BlendMode mode, bool deffered = false)
        {
            BlendMode(layer, mode.ToString(), deffered);
        }

        public void BlendMode(int layer, string mode, bool deffered = false)
        {
        ...
        public void Opacity(int layer, float opacity, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Brightness(int layer, float brightness, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Saturation(int layer, float saturation, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Constrast(int layer, float constrast, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Levels(int layer, float minInput, float maxInput, float gamma, float minOutput, float maxOutput, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Fill(int layer, float x, float y, float xScale, float yScale, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Clip(int layer, float x, float y, float width, float height, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Anchor(int layer, float x, float y, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Anchor(int layer, float topLeftX, float topLeftY, float topRightX, float topRightY, float bottomRightX, float bottomRightY, float bottomLeftX, float bottomLeftY, uint duration, Easing ease, bool deffered = false)
        {
        ...
        public void Crop(int layer, float leftEdge, float rightEdge, float topEdge, float bottomEdge, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void Rotation(int layer, float rotationAngle, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void MipMap(int layer, bool enable, bool deffered = false)
        {
        ...
        private static string BoolToNumericString(bool enable)
        {
            return enable ? "1" : "0";
        }

        public void Volume(int layer, float volume, bool deffered = false)
        {
        ...
        public void Volume(int layer, float volume, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        public void MasterVolume(int layer, float volume, bool deffered = false)
        {
        ...
        public void StraightAlphaOutput(int layer, bool enable, bool deffered = false)
        {
        ...
        public void StraightAlphaOutput(int layer, int gridSize, uint duration = 0, Easing ease = Easing.None, bool deffered = false)
        {
        ...
        private static string GetDefferMode(bool deffered)
        {
